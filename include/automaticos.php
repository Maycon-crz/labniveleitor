<?php 
	...
	";
	$_SESSION['outras_pastas_selecionar_tabela_tranferir'] = "
			...
			<div class='col-4 bg-success border border-warning'>
				<ul class='m-0 p-0'>
					<li class='text-center text-warning'>
						<!-- <h5 class='mt-3'>Pastas Para Amanhã em diante:</h5>(mudar na tabela no DB) -->
	...
	";
	$_SESSION['tbHorariosLinhaQuatro'] = "
	...
	";
	$_SESSION['cadastro_de_msgs_prontas'] = "
		<div class='row border border-success'>
			<div class='col-12 text-center'>
	...
	";
	$_SESSION['cadastro_de_funcionarios'] = "
		<div class='row'>
			<div class='col-12 border border-success mt-5'>
			...
			<ul class='m-0 p-0' id='conteudoMenuFixo'>
				...
				<div id='linhaOpcoesLaboratorio'>
					<li>
						...
						<button type='button' class='btsPreProntos mt-2' id='DigitarPrePronto'>Digitar<br/>Pré-Pronto</button>
					</li><li>
						<div class='linhaPreProntos' id='linhaDigitarPrePronto'>
							<input type='text' placeholder='' size='16' id='DigitarPreProntoValor'/>						
							<button type='button' class='btsFaltaProducao form-control btn btn-warning' id='producao'>Produção</button>
						</div>
					</li><li>
	...
	";
	$_SESSION['pastas_azuis_layout_fixo'] = "
	...
	";
	$_SESSION['mostra_excipientes_pre_prontos_fixo'] = "
