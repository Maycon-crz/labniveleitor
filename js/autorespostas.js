...
function excluindoDinamicoMSGpronta(){
	$(document).on('click', '.btExcluindoDinamicoMSGpronta', function(){
		var nomeDaColunaNatabela = $(this).attr("id");
		var idDaLinhaDoInputParaExcluir = $(this).val();
		alert("Excluir "+nomeDaColunaNatabela+" Onde O ID for igual a: "+idDaLinhaDoInputParaExcluir);
	});
}
